...
class Header extends Component { //compone class

    state = {// it holds all the value
        userName: '',
        email: '',
        password: '',
        confirmPassword: '',
    ...
    handleChange = (values) => { // handle change event 
        this.setState({
    ...
    validationSchema = Yup.object().shape({ //define rules for form field yup schema validation 
        userName: Yup.string()
